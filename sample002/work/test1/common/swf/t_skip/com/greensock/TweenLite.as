class com.greensock.TweenLite extends com.greensock.core.TweenCore
{
    ...
    static var _timingClip, rootTimeline, rootFramesTimeline, rootFrame, overwriteManager, onPluginEvent;
    function TweenLite(target, duration, vars)
    {
        ...
        {
            var _loc7 = _root.getBytesLoaded() == undefined ? (com.greensock.TweenLite.findSubloadedSWF(_root)) : (_root);
            for (var _loc6 = 999; _loc7.getInstanceAtDepth(_loc6) != undefined; ++_loc6)
            {
            } // end of for
            _timingClip = _loc7.createEmptyMovieClip("__tweenLite" + String(com.greensock.TweenLite.version).split(".").join("_"), _loc6);
    ...
    function renderTime(time, suppressEvents, force)
    {
        ...
        if (_loc5 == 0 && vars.onStart && cachedTime != 0 && !suppressEvents)
        {
    ...
    function setEnabled(enabled, ignoreTimeline)
    {
        if (enabled == gc)
        {
            if (enabled)
            {
                var _loc3 = com.greensock.TweenLite.masterList[_targetID].tweens;
                if (_loc3)
                {
    ...
    {
        var _loc5 = com.greensock.TweenLite.getID(target, true);
        var _loc3 = com.greensock.TweenLite.masterList[_loc5].tweens;
        var _loc2;
        var _loc1;
        if (_loc3 != undefined)
        {
            ...
            delete com.greensock.TweenLite.masterList[_loc5];
        } // end if
    } // End of the function
